...
<!--구글 애드센스-->
<script async
	src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2370297300940223"
...
<script>
	var img = {
		redBus : [ 'url(/spring/images/mainIndex/redBus_1.png)',
				'url(/spring/images/mainIndex/redBus_2.png)',
				'url(/spring/images/mainIndex/redBus_3.png)' ],
		yellowBus : [ 'url(/spring/images/mainIndex/yellowBus_1.png)',
				'url(/spring/images/mainIndex/yellowBus_2.png)',
				'url(/spring/images/mainIndex/yellowBus_3.png)' ],
		blueBus : [ 'url(/spring/images/mainIndex/blueBus_1.png)',
				'url(/spring/images/mainIndex/blueBus_2.png)',
				'url(/spring/images/mainIndex/blueBus_3.png)' ],
		weatherBack : [
				'url(/spring/images/mainIndex/weatherBackground_1.png)',
				'url(/spring/images/mainIndex/weatherBackground_2.png)',
				'url(/spring/images/mainIndex/weatherBackground_3.png)' ],
		findWayBack : [ 'url(/spring/images/mainIndex/menu_top_1.png)',
				'url(/spring/images/mainIndex/menu_top_2.png)',
				'url(/spring/images/mainIndex/menu_top_3.png)' ],
		scheduleBack : [ 'C',
				'url(/spring/images/mainIndex/menu_bottom_2.png)',
				'url(/spring/images/mainIndex/menu_bottom_3.png)' ],
	};
	...
	function changeImgByTime() {
		if (hour > 7 && hour < 17) {
			$('#container_top_weather').css('background-image',
					img.weatherBack[0]);
			$('#container_top_findWay').css('background-image',
					img.findWayBack[0]);
			$('#container_top_schedule').css('background-image',
					img.scheduleBack[0]);
		...
		$
				.ajax({
					...
					success : function(data) {
						...
						$("#container_top_weather_bottom_temperature").text(
								temp + '°');
						$("#container_top_weather_bottom_weatherIcon").css(
								"content",
								"url('/spring/images/mainIndex/" + waetherIcon
										+ ".png')")
						$("#container_top_weather_bottom_weatherStatus").text(
								status);
					}
				});
	}
	...
	function changeDate() {
		...
		$('#container_top_weather_top_date').text(
				yyyy + '년 ' + mm + '월 ' + dd + '일 ' + week);
	...
	(function($) {
		...
		internal = {
			...
			setItemLayout : function(el, state, options) {
				...
				if (isNaN(options.height) || options.height === 0) {
					...
					return el.height((state.itemHeight + box)
							* options.showItems + options.margin);
				} else {
		...
		return $.fn.vTicker = function(method) {
			...
			return $.error('Method ' + method
					+ ' does not exist on jQuery.vTicker');
		};
	})(jQuery);
...
@font-face {
	...
	src: url(/spring/css/2022css/2022/Pretendard-Bold.subset.woff2)
		format("truetype");
}

@font-face {
	font-family: "Pretendard-ExtraLight";
	src: url(/spring/css/2022css/2022/Pretendard-ExtraLight.subset.woff2)
		format("truetype");
}

@font-face {
	font-family: "Pretendard-Medium";
	src: url(/spring/css/2022css/2022/Pretendard-Medium.subset.woff2)
		format("truetype");
}

@font-face {
	font-family: "Pretendard-SemiBold";
	src: url(/spring/css/2022css/2022/Pretendard-SemiBold.subset.woff2)
		format("truetype");
}
...
<body>
	...
	%>
	<img src="/spring/images/team.png" class="busteam"
		style="width: 100%; top: 0; left: 0; z-index: 999; display: none;">
	<div id="content">
		<div id="header">
				...
				<div id="header_notice_mid">
					<ul>
						<c:forEach items="${nList}" var="ndto">
							<li class="nContent" value="${ndto.noticeSeq}"><a
								href="/spring/user/noticeView.action?noticeSeq=${ndto.noticeSeq}">${ndto.noticeSubject}</a></li>
						</c:forEach>
					</ul>
				</div>
		...
		<div id="container">
			<div id="container_top">
				...
				<div id="container_top_right">
					<div id="container_top_findWay"
						onclick="location.href='/spring/user/seoulBus.action'">
						<div class="container_top_right_blank"></div>
						<div id="container_top_findWay_left"></div>
						<div id="container_top_findWay_right">학교방향 광역노선</div>
						<div class="container_top_right_blank" style="clear: both"></div>
					</div>
					<div id="container_top_blank"></div>
					<div id="container_top_schedule"
						onclick="location.href='/spring/busSchedule/busTimeTable.action';">
						<div class="container_top_right_blank"></div>
						<div id="container_top_schedule_left"></div>
						<div id="container_top_schedule_right">통학버스 시간표</div>
						<div class="container_top_right_blank" style="clear: both"></div>
					</div>
				</div>
				<div style="clear: both"></div>
			...
			<div id="container_mid">
				...
				<div id="container_mid_blueBus" class="container_bus_rayout"
					value="18"
					onclick="location.href='/spring/getBusStopLine.action?universitySeq=${universityDto.universitySeq}&busStopCategorySeq=18';">
					...
					<div id="container_mid_blueBus_text">시내순환셔틀</div>
				</div>
				<div id="container_mid_yellowBus" class="container_bus_rayout"
					value="36"
					onclick="location.href='/spring/getBusStopLine.action?universitySeq=${universityDto.universitySeq}&busStopCategorySeq=36';">
					...
					<div id="container_mid_yellowBus_text">시청역순환셔틀</div>
				</div>
				<div id="container_mid_redBus" class="container_bus_rayout"
					value="36"
					onclick="location.href='/spring/getSchoolBusStopLine.action';">
					<div id="container_mid_redBus_dot" class="checkBus_box"
						style="background-color: gray;"></div>
					<div id="container_mid_redBus_text">광역노선통학버스</div>
				</div>
				<div style="clear: both;"></div>
			</div>
			<div id="container_bottom">
				...
				<div id="container_bottom_menu">
					<div id="container_bottom_menu_food" class="container_bottom_menu"
						onclick='location.href="https://www.mocko.kr/restaurant/31"'>
					...
					<div id="container_bottom_menu_notice"
						class="container_bottom_menu"
						onclick="location.href='https://www.yongin.ac.kr/cmn/sym/mnu/mpm/101080200/htmlMenuView.do'">
					...
					<div id="container_bottom_menu_sns" class="container_bottom_menu"
						onclick="location.href='/spring/camsns/snsMain.action?universitySeq=${universityDto.universitySeq}';">
				...
				<!-- <div id = "container_bottom_adver" onclick="location.href='https://akrk.kr'"></div> -->
				<div style="clear: both;"></div>
			</div>
		</div>
		<div id="footer">
			...
			<div id="footer_tip">
				<div id="footer_tip_left"
					onclick="location.href='/spring/user/makeIcon.action'">
					<div class="footer_tip_blank"></div>
					<div id="footer_tip_left_top">YBUS 이용 팁</div>
					<div class="footer_tip_blank"></div>
					<div id="footer_tip_left_bottom">
						YBUS를<br>앱처럼<br>사용하고싶다면?
					</div>
				</div>
				<div id="footer_tip_right">
					...
					<ins class="adsbygoogle"
						...
						data-ad-client="ca-pub-2370297300940223" data-ad-slot="2200350134"></ins>
					<script>
	...
	<div id="main_footer">
		<div id="logo">
			<a href="/spring/admin/adminLogin.action"> <img
				style="width: 100%;" src="/spring/images/mainIndex/YBUS_footer.png">
			</a>
		</div>
		<div id="prevVersion">
			<span>이전 버전으로 </span>
		...
		<div id="info">
			...
			<div id="info_right">
				<div id="info_right_gmail"
					onclick="location.href='mailto:eeu4327@gmail.com'"></div>
				<div id="info_right_kakao"
					onclick="location.href='http://pf.kakao.com/_Rxkxjxeu'"></div>
			</div>
			<div style="clear: both;"></div>
		</div>
	</div>

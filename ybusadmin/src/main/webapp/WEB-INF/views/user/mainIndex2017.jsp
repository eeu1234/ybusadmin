		...
		<div id="content">
			...
			<div id="camMain">
				<div class="iconBox" onclick="location.href='/spring/cambus.action'">
					<div class="iconImg"><img src="./images/mainImage/old_mainImage/camMain.png" style="width:50%;height:auto;" /></div>
			...
			<div id="cityBus">
            	...
            	<div class="iconImg"><img src="./images/mainImage/old_mainImage/cityBus.png" alt="" /></div>
			...
			<div id="forthBox" class="BSC4" onclick="location.href='/spring/busSchedule/busTimeTable.action';">
				...
				<div class="iconBox">
            	<div class="iconImg"><img src="./images/mainImage/old_mainImage/busTimeTable.png" alt="" /></div>
			...
			<div id="fifthBox" class="BSC5" onclick="location.href='/spring/camsns/snsMain.action?universitySeq=${universityDto.universitySeq}';">
				<div class="iconBox">
            	<div class="iconImg"><img src="./images/mainImage/old_mainImage/camsns.png" alt="" /></div>
			...
			<div id="sixthBox" class="BSC6" onclick="location.href='/spring/user/makeIcon.action'">
				<div class="iconBox">
            	<div class="iconImg"><img src="./images/mainImage/old_mainImage/howToAdd.png" alt="" /></div>
               	<div class="iconInfo"></div>
	...
	<c:forEach items="${bscList}" var="bscDto" varStatus="status">
		...
		<c:choose>
			<c:when test="${status.count==1}">
				img.setAttribute("src","./images/mainImage/old_mainImage/mainBus.png");
			</c:when>
			<c:when test="${status.count==2}">
			img.setAttribute("src","./images/mainImage/old_mainImage/mainBus.png");
			</c:when>
			<c:when test="${status.count==3}">
			img.setAttribute("src","./images/mainImage/old_mainImage/schoolBus.png");
			</c:when>
		</c:choose>

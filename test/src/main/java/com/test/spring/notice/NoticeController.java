...
public class NoticeController {
   ...
   public String noticeUpdate(HttpServletRequest request, HttpSession session, HttpServletResponse response
      ...
      // 공지사항 게시글 정보 가져오기
      NoticeDTO noticeCount = dao.notice(seq);
      
      String content = noticeCount.getNoticeContent();
      String regdate = noticeCount.getNoticeRegdate().substring(0,16);
      String subject = noticeCount.getNoticeSubject();
      String status =  noticeCount.getNotisStatus();
      String noticeSeq = noticeCount.getNoticeSeq();

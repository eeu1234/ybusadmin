...
<body>
	<div id="container">
		...
		<div id="contents">
			<div class="tab">
				<a href="javascript:void(0)" class="tablinks" style="border-left: 1px solid #003140; " id="busStopview" onclick="location.href='/spring/getBusStop.action'">정류장 뷰</a> 
				<a href="javascript:void(0)" style="border-bottom: 5px solid #003d4f; border-left: 1px solid #003140; border-right: 1px solid #003140;" class="tablinks" onclick="location.href='/spring/getBusStop2.action'">정류장 지도</a>
